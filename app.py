...
""",
    ...
    if not st.session_state.get("auth_splash_done"):
        ...
        _splash_css = (
            ...
            ".ns-sp-copy1{font-size:clamp(0.75rem,3vw,0.85rem);font-weight:700;"
            "color:rgba(255,255,255,0.75);line-height:1.4;margin-bottom:3px;}\n"
            ".ns-sp-copy1 em{font-style:normal;color:#fbbf24;font-weight:800;}\n"
            ".ns-sp-copy2{font-size:clamp(0.78rem,3.2vw,0.9rem);font-weight:800;"
