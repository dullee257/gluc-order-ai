...
""",
    ...
    if not st.session_state.get("auth_splash_done"):
        ...
        _splash_css = (
            ...
            "/* 드로어 헤더: 구글 버튼과의 간격 확보 및 글씨 잘림 방지 */\n"
            ".ns-sp-drawer-header{text-align:center!important;margin:0 0 24px!important;position:relative!important;"
            "z-index:44!important;padding-bottom:4px!important;}\n"
